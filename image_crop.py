...
parser.add_argument('--KITTI', default='2015',
                    help='KITTI version')
parser.add_argument('--datapath', default='G:/xunlei/kitti_2015/testing/',
                    help='select model')
parser.add_argument('--loadmodel', default='G:/xunlei/pretained_model/pretrained_model_KITTI2015.tar',
                    help='loading model')
...
def main():
    ...
    if imgL.shape[3] % 16 != 0:
        ...
        left_pad = 0
    imgL = np.lib.pad(imgL, ((0, 0), (0, 0), (top_pad, 0), (0, left_pad)), mode='constant', constant_values=0)      #每行前增加了top_pad行，每列前增加了left_pad列
